...
<form id="myform1">
    <fieldset>
        ...
        用户编号:<input id="userno" name="userno"/>
        用户名:<input id="username" name="username"/>
        用户手机号:<input id="telphone" name="telphone"/>
        用户地址:<input id="address" name="address"/>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    tr+="<td><button onclick='delStu("+data[i].selltoNo+")' type=\"button\" class='btn btn-primary btn-lg ' >删除</button>" +
